...
#Output = EUR 100
#Issue Identified: When we passed in a value of 50km/h for the speed and 30km/h for the speed limit, the expected #output should be EUR 80. However, the expected output is false and the condition indicated in the specification is #not met.
...
#Output = Blank Space
#Issue Identified: When we passed in a randomly selected number to be the speed (i.e speed = 120km/h) and set the #speed limit to be above the condition indicated by the program (i.e speed limit = 140km/h), the expected output was #false. The expected output returned just blank spaces.
